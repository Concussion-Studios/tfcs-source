...
//===========================
	...
	//tfc anims
	ADD_ACTIVITY_TO_SR ( ref_aim_AC );
	ADD_ACTIVITY_TO_SR ( crouch_idle );
	ADD_ACTIVITY_TO_SR ( crouch_aim_AC );
	ADD_ACTIVITY_TO_SR ( run2 );
	ADD_ACTIVITY_TO_SR ( walk2handed );
	ADD_ACTIVITY_TO_SR ( ref_shoot_AC );
