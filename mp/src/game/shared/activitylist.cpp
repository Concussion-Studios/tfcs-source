...
//HL2MP
	...
	//tfc anims
	REGISTER_SHARED_ACTIVITY ( ref_aim_AC );
	REGISTER_SHARED_ACTIVITY ( crouch_idle );
	REGISTER_SHARED_ACTIVITY ( crouch_aim_AC );
	REGISTER_SHARED_ACTIVITY ( run2 );
	REGISTER_SHARED_ACTIVITY ( walk2handed );
	REGISTER_SHARED_ACTIVITY ( ref_shoot_AC );
